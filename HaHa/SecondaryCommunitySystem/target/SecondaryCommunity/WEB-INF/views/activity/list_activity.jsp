    ...
    <div>
        ...
        <div style="float: left;">
            <ul class="breadcrumb" style="width: 1500px">
                <li>活动管理</li>
                <li class="active">/活动信息列表</li>
            </ul>
            <div class="my-2 text-right">
                <button class="btn btn-primary" onclick="location.href='<c:url value="/join/list"/>'">参加人员活动名单</button>
                <button class="btn btn-primary" onclick="location.href='<c:url value="/activity/input"/>'">发布活动</button>
            </div>
