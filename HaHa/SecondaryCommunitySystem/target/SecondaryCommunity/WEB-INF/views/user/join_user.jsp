...
<div>
    <div>
        ...
        <div class="my-2 text-right" style="width: 1500px">
            <a class="btn btn-primary" href="/SecondaryCommunity/user_act" style="margin-left: 10px">返回</a>
        </div>
        <div style="width: 1000px;margin-left: 20%">
            <form action="<c:url value="/user_act/joins"/>" class="col-6" method="post">
                <h2>您确认要参加该活动吗?报名信息如下：</h2>
                <div>
                    <div>
                        <div class="form-group row">
                            <label class="col-3 col-form-label">报名编号</label>
                            <div class="col-6">
                                <input type="text" class="form-control" onclick="time()" id="t" name="join_id" value="">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-3 col-form-label">报名人员账号</label>
                            <div class="col-6">
                                <input type="text" class="form-control" name="join_userno" value="${LoginedUser.user_no}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-3 col-form-label">报名人员名称</label>
                            <div class="col-6">
                                <input type="text" class="form-control" name="join_username" value="${LoginedUser.user_name}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-3 col-form-label">活动编号</label>
                            <div class="col-6">
                                <input type="text" class="form-control" name="join_actno" value="${activity.act_no}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-3 col-form-label">活动发布者名称</label>
                            <div class="col-6">
                                <input type="text" class="form-control" name="join_actname" value="${activity.act_name}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-3 col-form-label">活动时间</label>
                            <div class="col-6">
                                <input type="text" class="form-control" name="join_acttime" value="${activity.act_uptime}~${activity.act_downtime}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-3 col-form-label">活动标题</label>
                            <div class="col-6">
                                <input type="text" class="form-control" name="join_acttitle" value="${activity.act_title}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-3 col-form-label">活动积分</label>
                            <div class="col-6">
                                <input type="text" class="form-control" name="join_actnum" value="${activity.act_number}">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                    <button class="btn btn-primary">确认参加</button>
                    <a class="btn btn-primary" href="/SecondaryCommunity/user_act" style="margin-left: 10px">取消</a>
                </div>
            </form>
        </div>
    </div>
