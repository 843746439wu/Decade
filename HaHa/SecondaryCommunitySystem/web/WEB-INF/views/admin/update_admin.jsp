...
<div>
	...
	<div>
		<div style="background-color: #31424B;width: 180px;height: 760px;float: left;">
		...
		<div style="float: left;">
			...
			<form action="<c:url value="/admins/list"/>/${LoginedAdmin.admin_number}" class="col-6" method="post" enctype="multipart/form-data">
				...
				<div class="form-group row">
					...
					<div class="col-6">
						<input type="password" class="form-control" name="admin_id" value="${LoginedAdmin.admin_password}">
					</div>
				</div>
				<div class="form-group row">
					<label class="col-3 col-form-label">管理员身份证</label>
					<div class="col-6">
						<input type="text" class="form-control" name="admin_id" value="${LoginedAdmin.admin_id}">
					</div>
				</div>
				<div class="form-group row">
					<label class="col-3 col-form-label">管理员电话</label>
					<div class="col-6">
						<input type="text" class="form-control" name="admin_phone" value="${LoginedAdmin.admin_phone}">
					</div>
				</div>
				<div class="form-group row">
					<label class="col-3 col-form-label">管理员家庭地址</label>
					<div class="col-6">
						<input type="text" class="form-control" name="admin_address" value="${LoginedAdmin.admin_address}">
					</div>
				</div>
				<div class="form-group row">
					<label class="col-3 col-form-label">管理员邮箱</label>
					<div class="col-6">
						<input type="text" class="form-control" name="admin_email" value="${LoginedAdmin.admin_email}">
					</div>
				</div>
				<div class="form-group row">
					<label class="col-3 col-form-label">管理员生日</label>
					<div class="col-6">
						<input type="text" class="form-control" name="admin_birth" value="${LoginedAdmin.admin_birth}">
					</div>
				</div>
				<div class="form-group row">
					<label class="col-3 col-form-label">管理员QQ</label>
					<div class="col-6">
						<input type="text" class="form-control" name="admin_qq" value="${LoginedAdmin.admin_qq}">
					</div>
				</div>
				<div class="form-group row" style="margin-left: 50px">
					<img id="picAdmin" src="<c:url value="/admins/list"/>/${LoginedAdmin.admin_number}/adminpic" class="py-1" style="width: 250px;height: 150px;margin-left: 150px">
				</div>
				<div class="form-group row">
