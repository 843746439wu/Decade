	...
	<div>
		...
		<div style="float: left;">
			<div style="width: 1500px">
				...
				<form action="<c:url value="/commodity"/>/${commodity.commodity_name}" class="col-6" method="post" enctype="multipart/form-data">
					<input type="hidden" name="_method" value="PUT"/>
					<div class="form-group row">
						<label class="col-3 col-form-label">商品ID</label>
						<div class="col-6">
							<input type="text" class="form-control" name="commodity_id" value="${commodity.commodity_id}">
						</div>
					</div>
					<div class="form-group row">
					...
					<div class="form-group row">
						...
						<div class="col-6">
							<input type="text" class="form-control" name="commodity_price" value="${commodity.commodity_price}">
						</div>
					</div>
					<div class="form-group row">
						<label class="col-3 col-form-label">商品描述</label>
						<div class="col-6">
							<input type="text" class="form-control" name="commodity_describe" value="${commodity.commodity_describe}">
						</div>
					</div>
					<div class="form-group row" style="margin-left: 40px">
						<img id="picImg" src="<c:url value="/commodity"/>/${commodity.commodity_name}/commpic" class="py-1" style="width: 250px;height: 150px;margin-left: 150px">
					</div>
					<div class="form-group row">
					...
					<div class="form-group row">
						...
						<div class="col-6">
							<input type="text" class="form-control" name="commodity_num" value="${commodity.commodity_num}">
						</div>
					</div>
					<div class="form-group row">
						<label class="col-3 col-form-label">商品规模</label>
						<div class="col-6">
							<input type="text" class="form-control" name="commodity_style" value="${commodity.commodity_style}">
						</div>
					</div>
					<div class="form-group row">
						<label class="col-3 col-form-label">商品运费</label>
						<div class="col-6">
							<input type="text" class="form-control" name="commodity_shipping" value="${commodity.commodity_shipping}">
						</div>
					</div>
					<div class="form-group row">
						<label class="col-3 col-form-label">商品折扣</label>
						<div class="col-6">
							<input type="text" class="form-control" name="commodity_discount" value="${commodity.commodity_discount}">
						</div>
					</div>
					<div class="form-group row">
						<label class="col-3 col-form-label">商品货源</label>
						<div class="col-6">
							<input type="text" class="form-control" name="commodity_address" value="${commodity.commodity_address}">
						</div>
					</div>
					<div class="form-group row">
						<button class="btn btn-primary">修改商品</button>
