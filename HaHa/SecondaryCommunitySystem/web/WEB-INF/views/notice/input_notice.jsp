...
<div>
	...
	<div>
		...
		<div style="float: left;">
			...
			<form action="<c:url value="/notice"/>" class="col-6" method="post">
				<div class="form-group row">
					<label class="col-3 col-form-label">编号</label>
					<div class="col-6">
						<input type="text" class="form-control" name="notice_no" value="">
					</div>
				</div>
				<div class="form-group row">
					<label class="col-3 col-form-label">管理员名称</label>
					<div class="col-6">
						<input type="text" class="form-control" name="notice_name" value="">
					</div>
				</div>
				<div class="form-group row">
					<label class="col-3 col-form-label">开始时间</label>
					<div class="col-6">
						<input type="text" class="form-control" name="notice_uptime" value="">
					</div>
				</div>
				<div class="form-group row">
					<label class="col-3 col-form-label">结束时间</label>
					<div class="col-6">
						<input type="text" class="form-control" name="notice_downtime" value="">
					</div>
				</div>
				<div class="form-group row">
					<label class="col-3 col-form-label">公告标题</label>
					<div class="col-6">
				...
				<div class="form-group row">
					...
					<div class="col-6">
						<input type="text" class="form-control" name="notice_content" value="">
					</div>
				</div>
				<div class="form-group row">
