...
<head>
    ...
    <script type="text/javascript">
        ...
        function showRemoveDlg(notice_no){
            delActivityNO=notice_no;
            $("#message").html('您确认要删除的编号为['+notice_no+']的活动或公告吗?');
            $("#removeNoticeModal").modal('show');
        }

        function removeNotice(){
            document.forms[0].action="<c:url value="/notice"/>/"+delNoticeNO;
    ...
    <div>
        ...
        <div style="float: left;">
            ...
            <div class="my-2 text-right">
                <button class="btn btn-primary" onclick="location.href='<c:url value="/notice/input"/>'">发布公告</button>
            </div>
                    ...
                    <tbody>
                        <c:forEach var="notice" items="${noticeList}" varStatus="idx">
                            <tr>
                                ...
                                <td>
                                    <div>${notice.notice_name}</div>
                                </td>
                                <td>
                                    <div>${notice.notice_uptime}~${notice.notice_downtime}</div>
                                </td>
                                <td>
                                ...
                                <td>
                                    <div><button class="btn btn-danger btn-sm" onclick="showRemoveDlg('${notice.notice_no}')">删除</button></div>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-primary" onclick="removeNotice()">确认删除</button>
                        </div>
                    </div>
                </div>
            </div>
