...
<div>
    <div>
        ...
        <div style="margin-left: 15%">
            <form action="<c:url value="/user_commodity/order/"/>" class="col-6" method="post">
                <h2>购买后订单生成?订单信息如下：</h2>
                <div style="width: 500px;float: left;margin-left: 10%">
                    <div class="form-group row">
                        <label class="col-3 col-form-label">订单编号：</label>
                        <div class="col-6">
                            <input style="border: none" readonly="readonly" type="text" id="t" class="form-control" name="order_id" value="">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-6">
                            <input style="border: none" type="text" class="form-control" name="user_phone" value="${LoginedUser.user_phone}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-3 col-form-label">用户地址：</label>
                        <div class="col-6">
                            <input style="border: none" type="text" class="form-control" name="user_address" value="${LoginedUser.user_address}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-3 col-form-label">购买时间：</label>
                        <div class="col-6">
                            <input style="border: none" readonly="readonly" type="text" id="ordertime" class="form-control" name="order_time" value="">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-6">
                            <input style="border: none;" type="text" onclick="time()" class="form-control" name="order_number" id="number" value="">
                        </div>
                    </div>
                    <div class="form-group row">
